...
export default function Career() {
  ...
  return (
    <section className="relative z-10 min-h-screen text-black dark:text-white py-22 transition-colors duration-500">
      <div className="bg-black dark:bg-transparent p-4 text-white">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">Careers</h2>
        <p className="text-center text-sm md:text-base max-w-2xl mx-auto mb-10 text-gray-200 dark:text-gray-300">
          Explore the world of opportunity where your ideas lead to innovation and your ambitions are realized.
          Join us to shape the future of our industry and your career in an environment that values growth,
