...
const BookCall = () => {
    ...
    return (
        <div ref={ref} className='relative  flex justify-center items-center z-10 my-30  max-w-2xl'>
            {!verified ? (
                <motion.div
                    initial={{ opacity: 0, y: 40 }}
                    animate={isInView ? { opacity: 1, y: 0 } : {}}
                    transition={{ duration: 0.6 }}
                    className="w-full flex justify-center items-center  max-w-xl"
                >
                    <motion.form
                        variants={fadeUp}
                        initial="hidden"
                ...
                <motion.div
                    ref={ref1}
                    className="bg-white mx-2 dark:bg-white/10 backdrop-blur-md shadow-2xl border border-gray-300 dark:border-white/20 text-gray-900 dark:text-white rounded-xl relative overflow-hidden p-5 space-y-5"
                >
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    className="bg-white mx-2 z-10 dark:bg-white/10 backdrop-blur-md shadow-2xl border border-green-500/30 dark:border-white/20 rounded-xl relative overflow-hidden p-5 space-y-5"
                >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full translate-x-1/3 -translate-y-1/3" />
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-white/10 rounded-full -translate-x-1/3 translate-y-1/3" />
