...
const OurJourney = () => {
  ...
  return (
    <section className="relative z-10  px-4 md:px-10 lg:px-20 py-16  text-gray-900 dark:text-white">
      <div ref={ref} className=" text-xl md:text-2xl lg:text-3xl font-bold text-center mb-6 ">
        <motion.div
      ...
      <div className="w-full px-4 mt-6 overflow-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="relative z-10 text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-center mt-6 mb-3"
        >
          <BlurText
