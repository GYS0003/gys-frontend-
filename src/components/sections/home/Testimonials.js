    ...
    <section className="  py-16 relative z-10 overflow-hidden">
      ...
      >
        {testimonials.map((item, index) => (
          <div
            key={index}
            className="min-w-[200px] max-w-[250px] md:min-w-[300px] md:max-w-[340px] bg-white dark:bg-white/10 backdrop-blur-md shadow-md rounded-2xl border border-gray-300 dark:border-white/20 p-6 text-center flex-shrink-0 my-4 transition-transform select-none hover:scale-105"
          >
