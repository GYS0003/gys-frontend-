      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-10">
        ...
        {/* <Link href="/samsara-studio"> */}
          ...
          >
            ...
            <h3 className="text-2xl font-semibold my-2">Samsara Studio</h3>
            <p className="text-gray-800/90 dark:text-white/90 text-sm">
              Samsara Studio delivers impactful digital marketing solutions that
              fuse creativity, strategy, and innovation. From branding and social
              media to performance marketing and content creation, we help
              businesses grow and connect.
            </p>
            <ul className="list-disc list-inside mt-4 text-sm text-blue-600 dark:text-blue-100 space-y-1">
              ...
              <li>Creative content and campaign strategies</li>
