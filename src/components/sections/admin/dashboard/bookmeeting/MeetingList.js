        ...
        {filteredDates.map((date) => (
          <div key={date} className="mb-10">
            ...
            <table className="min-w-full text-sm table-auto border border-gray-300 dark:border-gray-700">
              <thead className="bg-gray-100 text-gray-800 dark:text-white dark:bg-gray-700">
                <tr>
                  ...
                  <th className="p-3 border border-gray-300 dark:border-gray-700 text-left">File</th>
              ...
              <tbody>
                {meetingsByDate[date].map((meeting, index) => (
                  ...
                  >
                    ...
                    <td className="p-3 border border-gray-300 dark:border-gray-700"> {meeting.uploadedFileUrl ? (
                        <a
                          href={meeting.uploadedFileUrl}
                          target="_blank"
