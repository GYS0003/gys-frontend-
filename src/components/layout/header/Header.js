            ...
            {navLinks.map((item) => {
              ...
              return (
                ...
                >
                  {item.label}
                  {isActive && (
                    <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-indigo-600 dark:bg-indigo-400"></span>
                  )}
                </Link>
              );
            })}
            ...
            {navLinks.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`block text-center text-sm py-2 border-b border-gray-200 dark:border-gray-700 ${
                    isActive
                      ? "text-indigo-600 dark:text-indigo-400 font-semibold"
